 ...
 *
 * <p>Basically it checks that the first {@link Header} has level {@code 1} and it's possible to
 * build a single table of contents from the given contents instance.
 */
